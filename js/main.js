...
mainTitle.innerText = "bugBusters e-commerce";


// by class name
const infoCollection = document.getElementsByClassName("info"); // returns an HTMLCollection
...
//note: querySelectorAll returns a nodelist (we can use forEach)
...
linkElm.innerText = "About us - BugBusters"
...
newImg.setAttribute("alt", "beautiful pikachu img");
...
const btnTwo = document.getElementById("add-paragraph");
btnTwo.addEventListener("click", () => {
    ...
    //step3: append to the dom: `parentElm.appendChild()`
    const container = document.getElementById("box-4");
